...
import (
	...
	"scbox/internal/third_party/esbuild/internal/ast"
	"scbox/internal/third_party/esbuild/internal/bundler"
	"scbox/internal/third_party/esbuild/internal/compat"
	"scbox/internal/third_party/esbuild/internal/config"
	"scbox/internal/third_party/esbuild/internal/css_ast"
	"scbox/internal/third_party/esbuild/internal/css_lexer"
	"scbox/internal/third_party/esbuild/internal/css_parser"
	"scbox/internal/third_party/esbuild/internal/css_printer"
	"scbox/internal/third_party/esbuild/internal/fs"
	"scbox/internal/third_party/esbuild/internal/graph"
	"scbox/internal/third_party/esbuild/internal/helpers"
	"scbox/internal/third_party/esbuild/internal/js_ast"
	"scbox/internal/third_party/esbuild/internal/js_lexer"
	"scbox/internal/third_party/esbuild/internal/js_printer"
	"scbox/internal/third_party/esbuild/internal/logger"
	"scbox/internal/third_party/esbuild/internal/renamer"
	"scbox/internal/third_party/esbuild/internal/resolver"
	"scbox/internal/third_party/esbuild/internal/runtime"
	"scbox/internal/third_party/esbuild/internal/sourcemap"
	"scbox/internal/third_party/esbuild/internal/xxhash"
)
			...
			for _, importRecordIndex := range part.ImportRecordIndices {
				...
				if otherRepr.Meta.Wrap != graph.WrapNone {
					...
					if otherRepr.Meta.Wrap == graph.WrapESM && record.Kind != ast.ImportStmt {
						...
						// https://scbox/internal/third_party/esbuild/issues/1591.
						if record.Kind == ast.ImportRequire {
...
func (c *linkerContext) renameSymbolsInChunk(chunk *chunkInfo, filesInOrder []uint32, timer *helpers.Timer) renamer.Renamer {
	...
	// this happened: https://scbox/internal/third_party/esbuild/issues/3544
	...
	for _, result := range results {
		...
		if file.InputFile.InputSourceMap == nil {
			...
			if file.InputFile.Source.KeyPath.Namespace == "file" {
				...
				//
				// See https://scbox/internal/third_party/esbuild/issues/4078 for more info.
